...
import { CartItem, Data, fullInvoice } from "../Redux/invoice";
            ...
            <div className="flex gap-28">
              <div className="">
                ...
                <div>
                  ...
                  <p className="font-medium">{service.serviceProviderPlace}</p>
                  <p className="font-medium">
                    {service.serviceProviderLocation}
                  </p>
                  <p className="font-medium">{service.serviceProviderNumber}</p>
                </div>
              </div>
              <div className="">
                <div>
